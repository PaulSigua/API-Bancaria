...
a persistence unit "apiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "api/pom.xml":
...
artifact ("api.war") is already built. You can build
